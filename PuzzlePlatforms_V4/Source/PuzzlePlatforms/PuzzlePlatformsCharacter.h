...
private:
	// Sends a message.
	// Only call this function if we are the server, otherwise use ServerSendChatMessage
	void SendChatMessage(const FString& Message);

	//Clears the current message.Called automatically 5 seconds after sending a message
